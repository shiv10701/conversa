...
function New_Message(props){
  ...
  async function save_images(){
    ...
    const result_save_image=await axios.post('http://192.168.0.98:5000/api/saveImages/saveImages',{...details},{headers: {'Content-Type': 'multipart/form-data','ngrok-skip-browser-warning': 'true'}});
